...
python ./NBLDPC_Software/NBLDPC_TEST_CN&VN.py
```
The default generated figure corresponding to the Fig.6(a)(b)(c)(d)(i) and Fig.4(f), generated by the function PlotSpace and PlotDesignExp, respectively.
The default parameters of the function is generated by the synthesis results using Synopsys Design Compiler at the ss corner, so the simulated results may be different from the measured result.
